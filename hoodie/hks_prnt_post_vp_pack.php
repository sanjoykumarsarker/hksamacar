            ...
            while ($row = $result_all->fetch_assoc()) {
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td> -->
                            <h4 style="font-size:16px; text-align: center;">ইংরেজি নববর্ষ ২০২৩ উপলক্ষে <strong>মাসিক হরেকৃষ্ণ সমাচারের</strong> পক্ষ থেকে আপনাকে জানাই <strong>কৃষ্ণপ্রীতি ও শুভেচ্ছা।</strong></h4>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 3in;">
                        ...
                        <td style="font-size:18px; text-align: left;">
                            Date: ' . $newDateString .'<br>RP:
                        </td>

                        <td style="width:100%;font-size:18px;padding-top:0px;padding-bottom:5px;">
                            প্রাপক, <br>
