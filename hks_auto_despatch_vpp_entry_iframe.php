...
$sql = "SELECT transid,vername, SentDate,agcpy ,count(transid) FROM tblIssue where sent_mode='vpp' AND vername =".$print_issue."  GROUP BY agcpy";
...
<form class="cl_form" method ="post" target="myframe"  action="hks_despatch_vpp_auto_entry_data.php"> 
...
$sql_all = "SELECT transid,vername, VPNo,SentDate,agcpy  FROM tblIssue where sent_mode='vpp' AND vername =".$print_issue." order by cast(VPNo as unsigned)  ";
