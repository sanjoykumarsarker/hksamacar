        ...
        if ($result_all->num_rows > 0) {
            ...
            while ($row = $result_all->fetch_assoc()) {
                ...
                echo '                
                    ...
                    <tr>
                    <td colspan="2">
                        <h4 style="font-size:20px;font-family:SutonnyMJ; text-align: left; font-weight: bold;"> ভিপিপি  মূল্য: ৳' . $new_num . '/-( <span id="w' . $row["transid"] . '" ></span>  )</h4>
                    </td>
                    <td>
                            ...
                            <td style="width: 2in;">
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        Date: ' . $newDateString . '<br> VPP No: <span style="font-size:22px;font-weight:bold">' .str_pad(intval($vpno),3,"0",STR_PAD_LEFT). '</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
