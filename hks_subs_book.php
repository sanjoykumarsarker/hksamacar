          ...
          <div class="page-content inset">
            <div class="row">
              <div class="col-md-12">
                      ...
                      <form id="ag_submit" method="post" class="form" role="form" target='iframe_subs_book' action="subs_book_search.php">
                        <div class="row">
                          <div class="col-sm-8 input-group">
                            <select class="col-3 custom-select mr-3" id="id_district" name="ag_dist" onchange="">
                            ...
                            <input class="col-9 form-control" id="ag_input" name="ag_search" placeholder="Type  to Search" type="text"  />
                          </div>
                          <div class="col-sm-4">
                            <button class="btn btn-primary" type="submit" name="type" value="Solvent">Solvent</button>
                ...
                <iframe id="printable" name='iframe_subs_book' height="500px" width=100% style="border:0"></iframe>
