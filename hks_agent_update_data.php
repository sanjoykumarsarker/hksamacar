...
$stmt = $conn->prepare("update tblMem set  Name =:Name,vill=:vill,po=:po,po_bn=:po_bn,ps=:ps,dist=:dist,cont=:cont,phone=:phone,mob=:mob,email=:email,comment=:comment,paymode=:paymode,user=:user,courier_name=:courier_name,courier_description=:courier_description where ID_EN=:ID_EN");
