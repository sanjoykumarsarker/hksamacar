...
<title>Hare Krishna Publications Products</title>
...
<div class="col-md-10 col-xl-10"> 
      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
            <div class="row">
              <div class="col-md-12">
              <p class="well lead" style="margin-top: 5px;" > Hare Krishna Publications- Products </p>
            <div class="container">
...
<td>'.round((doubleval($row["direct"])+doubleval($row["indirect"]))



/doubleval($row["quantity"]),2).'</td>

<input type="hidden" name="issue" value="'.$row["issue"].'">
<td> '.round(($row["np"])/doubleval($row["nr"]),2).'</td>
