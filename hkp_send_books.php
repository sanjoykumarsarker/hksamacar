...
document.getElementById("inv_total_due").value  =

parseInt(document.getElementById("inv_total_donation_id").value)-

parseInt(document.getElementById("inv_total_paid").value)-
  parseInt(document.getElementById("inv_disc").value);
...
function totalPaid() {
  ...
  sum=sum+parseInt(document.getElementById("name"+j+4).value);
        ...
        document.getElementById("inv_total_donation_id").value=sum;     
...
sum=sum+parseInt(document.getElementById("name"+j+2).value);
	...
	document.getElementById("inv_total_copy_id").value=sum;     
	//document.getElementById("max_val").value=id;	
...
var sss=this.responseText;
							 var res = sss.split("@#");
								 document.getElementById("inv_name").value = res[0];
								 document.getElementById("inv_addr").value = res[1];

                 document.getElementById("inv_mobile").value = res[2];
...
<div class="col-md-10 col-xl-10"> 
      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
            <div class="row">
              <div class="col-md-12">
              <p class="well lead" style="margin-top: 10px;" > Invoice (Send Books and Others) </p>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 contact-form"> <!-- div da direita -->
                        <form id="contact" method="post"  target="_blank"  action ="hks_inv_retail_data.php" class="form" role="form">
                            <div class="row">
							    <div class="col-xs-4 col-md-4 form-group">
                                    <input class="form-control" id="inputCNPJ" name="inv_trnx" value="<?php echo $GLOBALS['maxtransid'];?>" type="text" autofocus />
                                </div>
 								<div class="col-xs-4 col-md-4 form-group">
                                    <input class="form-control" id="transactionId" onkeyup="myFunction(this.value)" name="cash_trnx_id" placeholder="Agent/Subscriber/Customer No." type="text" autofocus />
                                </div>

 
								<div class="col-xs-4 col-md-4 form-group">
                                    <input class="form-control" id="inputCNPJ" name="inv_date"  value="<?php echo date("m/d/Y");?>" type="text"  />
                                </div>
                                <div class="col-xs-4 col-md-4 form-group">
                                    <input class="form-control" id="inv_name" name="inv_name" placeholder="Name" type="text" />
                                </div>
								<div class="col-xs-5 col-md-5 form-group">
                                    <input class="form-control" id="inv_addr" name="inv_addr" placeholder="Address" type="text" />
                                </div>
                                <div class="col-xs-3 col-md-3 form-group">
                                    <input class="form-control" id="inv_mobile" name="inv_mobile" placeholder="Mobile" type="text" />
                                </div>
							...
							<div class="row" style="background-color: cornsilk;">
								...
								<div class="col-xs-1 col-md-1 form-group">
									<div class="controls">
										...
										<input class="form-control" style="background-color: transparent;" id="inv_total_donation_id" name="inv_total_donation" onkeyup="paid(this.value)" placeholder="" type="text" />
									</div>
								</div>
								...
								<div class="col-xs-1 col-md-1 form-group">
									<div class="controls">
										...
										<input class="form-control" style="background-color: transparent;"id="inv_total_copy_id" name="inv_total_copy" onkeyup="paid(this.value)"  type="text" />
									</div>
								</div>
                                ...
                                <div class="col-xs-2 col-md-2 form-group">
									<div class="controls">
										...
										<input class="form-control" id="inv_disc" name="inv_disc"   onkeyup="paid(this.value)"  type="text" />
									</div>
								</div>
                	            ...
                	            <div class="col-xs-2 col-md-2 form-group">
									<div class="controls">
										...
										<input class="form-control" id="inv_total_paid" name="inv_total_paid" onkeyup="paid(this.value)" type="text" />
									</div>
								</div>
                	            ...
                	            <div class="col-xs-2 col-md-2 form-group">
									<div class="controls">
										<label for="" > Due </label>
										<input class="form-control" style="background-color: transparent;" id="inv_total_due" name="inv_total_due"  type="text" />
									</div>
								</div>
								...
								<div class="col-10 form-group" >
									<label class="radio-inline">
										<input type="radio" name="condition" checked>No Condition
									</label>
									<label class="radio-inline">
										<input type="radio" name="condition">Condition
									</label>
									<input class="form-control" id="ag_input" name="ag_search" placeholder="Confirm Condition Amount" type="text"  />
								</div>
								<div class="col-2 form-group" style="padding: 45px 0px 0px 40px;">
