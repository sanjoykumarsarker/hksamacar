...
if ($connr->connect_error) {
   ...
   ename,
   mstatus,
   nprefer,istatus1,isinitiated,finalname,iserial,finalname_b 
...
if ($resultr->num_rows > 0) {
    echo "<table>
  <tr>
  <th>ISERIAL</th><th>English Name</th> <th>Bangla Name</th>  <th>Click</th>   
  </tr>";
  ...
  
  {
    ...
    <form target='iframe1' action='enter_bangla_name_update.php' method='POST'>
    
    <td class='panel panel-info'>".$row["iserial"]."</td><td class='panel panel-info'>".$row["finalname"]."</td>
    ...
    <footer>
            <div class="row">
                <div class="col-lg-12" style= "text-align:center;cursor:pointer;">
                    <Span style="padding:10px"><p style= "cursor: pointer; display: inline;" > Powered by <a href="https://www.facebook.com/harekrishnasamacar/" target="_blank" >@hksamacar</a> 2017 </p> </span>
