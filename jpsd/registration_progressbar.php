...
$sql = "SELECT  count(datetime) as nrt FROM reg 
...
$sql = "SELECT COUNT(NULLIF(reg, '')) as nrt FROM reg WHERE isinitiated!='Initiated' and isinitiated!='Absent'";
$result = $conn->query($sql);
