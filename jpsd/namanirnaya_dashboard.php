...
echo $permis_val=getPermission($_SESSION['idnn'],$_SESSION['pwn']);
echo $id_val=getId($_SESSION['idnn'],$_SESSION['pwn']);
...
if($ccct>1){ $cctf=1 ; }
 ...
 $cctff=$cctff+	$cctf;
	...
	echo "<tr >
		...
		<td  style='text-align:left; width:60%;'  > <form action='finalname.php' method='POST'><button class= 'tbutton' name='edit' type='submit' value=".$row["templereg"]." > ".$rowin["tname"].",&nbsp ".$rowin["t_addr"].",&nbsp".$rowin["t_ps"].",&nbsp".$rowin["t_dist"]." </button> </form></td>
