...
<?php 
    ...
    session_start();
      ...
      $balance=0;
         ...
         echo "Date:"; 
    echo   $send_all_date=$_POST["send_single_date"];
    echo "<hr>";
    echo   $send_single_id=$_POST["send_single_id"];
$id=intval($send_single_id);
$type="";
if($id<100&&$id>0){
...
echo $type;
    ...
    $description="Since".$send_single_issue;
    echo "<hr>";
   ...
   // echo $type= $_POST["type"]; 
    ...
    $sql = "SELECT ID_EN,status,ag_quantity,courier_name,news_rate,courier_description FROM tblMem where ID_EN =".$id." and ID_EN <100 AND ID_EN >0 AND ag_quantity>0 AND status='CONT'";
    ...
    if(($type=="Agents")||($type=="All")){
        ...
        $sql = "SELECT ID_EN,status,ag_quantity,courier_name,news_rate,courier_description FROM tblMem where ID_EN =".$id." and ID_EN <10000 AND ID_EN >99 AND ag_quantity>0 AND status='CONT'";
        ...
        // Check connbalance FROM tblMemection
        if ($conn->connect_error) {
            die("Connection failed: " . $conn->connect_error);
        }
        $sql = "SELECT ID_EN,status,ag_quantity,balance FROM tblMem where ID_EN =".$id." and ID_EN >10000 AND ID_EN >0 AND balance>0 AND status='CONT'";
