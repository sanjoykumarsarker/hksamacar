...
<br>
	   ...
	   <tr  ><td style="font-size:24px; font-family:  SutonnyMJ">পত্রিকা -<span style=" font-family:  SutonnyMJ">' . $new_print_issue . '</span> </td><td style="font-size:24px;">' . doubleval($row["agcpy"]) . '</td><td  style="font-size:24px;" >' . doubleval(id_news_rate($row["transid"])) . '</td><td style="font-size:24px;" >' . intval(doubleval($row["agcpy"]) * doubleval(id_news_rate($row["transid"]))) . '</td></tr>
