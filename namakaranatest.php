...
if ($resultr->num_rows > 0) {
    ...
    while($row = $resultr->fetch_assoc()) {
		...
		<td><form> 
		<input class='tbutton'  type='button' value=".$row["reg"]." onclick='showResult(this.value)' /></form></td>
		<td>".$row["ename"]."</td>
		<td>".$row["nchoice1"]."</td>
		<td>".$row["nchoice2"]."</td><td>".$row["nchoice2"]. "</td></tr>";
    }
    echo "</table>";
}	else {
	echo "No---Result";     
...
<div id= "row" style="Padding:10px;" >
	...
	<div class="col-sm-4" style="  background-color:GhostWhite ;" > 
		<div id="tin" style="padding:5px; margin-top: 20px" > </div>
		</div>
 ...
 <div class="col-sm-4" style="  background-color:Cornsilk ;" > 
		...
		<form target="myframe" method="post" action="choice3_json.php" style="padding:10px">
			<div class="ui-widget">
				...
				<input type="text" id="tags1" name="nnn1" size="40" onkeyup = "showResultn(this.value)">
			</div>
			<div class="ui-widget">
				<label for="tags">❷ :</label>
				<input type="text" id="tags2" name="nnn2" size="40" onkeyup = "showResultn(this.value)">
			</div>
			<div class="ui-widget">
				<label for="tags">❸ :</label>
				<input type="text" id="tags3" name="nnn3" size="40" onkeyup = "showResultn(this.value)">
			</div>
