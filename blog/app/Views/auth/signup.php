        ...
        <div class="row justify-content-center form-bg-image" data-background-lg="../../assets/img/illustrations/signin.svg">
            <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                    ...
                    <?php $this->include('layout/alert') ?>
                    <form action="<?= url_to('signup.store') ?>" class="mt-4" method="post">
                        <?= csrf_field() ?>
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input name="name" type="text" class="form-control <?= display_error('name', true)  ?>" value="<?= old('name') ?>" placeholder="Name..." id="name" required>
                                <?= display_error('name') ?>
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input name="email" type="email" class="form-control <?= display_error('email', true)  ?>" value="<?= old('email') ?>" placeholder="Email ID..." id="email" autofocus required>
                                <?= display_error('email') ?>
                            </div>
                        </div>
                        <!-- End of Form -->
                        <div class="form-group">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="password" type="password" placeholder="Password <?= display_error('name', true)  ?>" class="form-control" id="password" required>
