<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="<?= url_to('dashboard') ?>">
        <!-- <img width="150" class="navbar-brand-dark" src="<?= assets_url('images/samacar_logo.svg') ?>" alt="hksamacar logo" /> <img class="navbar-brand-light" src="<?= assets_url('images/samacar_logo.svg') ?>" alt="hksamacar logo" /> -->
...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" style="scrollbar-width: thin;" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">

            <div class="d-block">
                <a href="<?= url_to('logout') ?>" class="btn btn-secondary btn-sm d-inline-flex align-items-center">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <!-- Side Nav Top -->
                <a href="<?= url_to('dashboard') ?>" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="<?= assets_url('images/samacar_logo.svg') ?>" height="20" alt="hksamacar Logo">
                    </span>
            ...
            <li class="nav-item <?= url_is('admin.posts') ? 'active' : '' ?>">
                ...
                <div class="multi-level collapse " role="list" id="submenu-app" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item ">
                            <a class="nav-link" href="<?= url_to('admin.posts') ?>">
                                <span class="sidebar-text">All Posts</span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="<?= url_to('admin.posts.new') ?>">
                                <span class="sidebar-text">Add Post</span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="<?= url_to('admin.category') ?>">
            ...
            <li class="nav-item <?= url_is('admin.epaper') ? 'active' : '' ?>">
                <a href="<?= url_to('admin.epaper') ?>" class="nav-link">
                    <span class="sidebar-icon">
                        <svg class="icon icon-sm me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="sidebar-text">Epapers</span>
                </a>
            </li>
            <li class="nav-item <?= url_is('admin.pages' . '*') ? 'active' : '' ?>">
                <a href="<?= url_to('admin.pages') ?>" class="nav-link">
                    <span class="sidebar-icon">
                        <svg class="icon icon-sm me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item <?= url_is('admin.users') ? 'active' : '' ?>">
                <a href="<?= url_to('admin.users') ?>" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-sm me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item <?= url_is('admin.roles') ? 'active' : '' ?>">
                <a href="<?= url_to('admin.roles') ?>" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-sm me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path>
            ...
            <li class="nav-item">
                <a href="<?= url_to('admin.settings') ?>" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse " role="list" id="submenu-components" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item">
                            <a class="nav-link" href="https://themesberg.com/docs/volt-bootstrap-5-dashboard/components/accordions/">
             ...
             -->
            <li role="separator" class="dropdown-divider mt-2 border-gray-700"></li>
            <li class="nav-item">
                <a href="<?= url_to('home') ?>" class="nav-link d-flex align-items-center" target="_blank">
                    <span class="sidebar-icon">
                        <svg class="icon icon-sm me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path>
                        </svg>
                    </span>
                    <span class="sidebar-text">View Home</span>
                </a>
            </li>
        </ul>
    </div>
