			...
			<article class="container box style3">
				...
				<form method="post" action="photography-contest-data.php" enctype="multipart/form-data"id="form">
					<div class="row gtr-50">
						...
						<div class="col-4 col-12-mobile"><input type="file"  name="fileToUpload1" accept=" .jpg, .jpeg" /></div>
						<div class="col-4 col-12-mobile"><input type="file"  name="fileToUpload2" accept=" .jpg, .jpeg" /></div>
						<div class="col-4 col-12-mobile"><input type="file"  name="fileToUpload3" accept=" .jpg, .jpeg" /></div>
						<div class="col-12">
							<textarea name="message" placeholder="বিবরণ  " ></textarea>
						</div>
						<div class="col-12">
							<ul class="actions">
