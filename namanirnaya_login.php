        ...
        $(window).on('popstate', function() {
          ...
          if (hashName !== '') {
           ...
           alert('Back button was pressed.');
                ...
                window.location='namanirnaya_login.php';
                return false;
            }
          }
        });

        window.history.pushState('forward', null, './namanirnaya_login.php');
      }
...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
  ...
  <div class="w3-display-middle">
	...
	<div class="sub-main-w3">
		...
		<form role="form" action="namanirnaya_dashboard.php" method="POST">
