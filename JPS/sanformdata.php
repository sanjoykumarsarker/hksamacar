...
VALUES ('".$tregs."' , 
    ...
    $sql_update="update reg set spouse_id='$tregs' where reg='$spouse_id'";
...
if ((!empty($spouse_id))&& ($connl->query($sql_update) === TRUE)) {
echo "<br>Spouse Also Updated";
}
