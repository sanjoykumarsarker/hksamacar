...
body {
    background-image: url("/JPS/rasika_maya.jpg");
    background-color: #cccccc;
}

.bgimg {
    background-image: url ('/JPS/rasika_tovp.jpg');
    min-height: 100%;
...
.sub-main-w3 input[type="submit"] {
	background: url('/JPS/rasika_arrow.png') no-repeat 30% 45%;
  height: 67px;
  outline: none;
  margin-top: 38px;
	margin-left: 100px;
        ...
        $(window).on('popstate', function() {
          ...
          if (hashName !== '') {
           ...
           alert('Back button was pressed.');
                window.location=`//${location.host}/JPS/viva`;
                return false;
            }
          }
        });

        window.history.pushState('forward', null, `//${location.host}/JPS/viva`);
      }
...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
  ...
  <div class="w3-display-middle">
	...
	<div class="sub-main-w3">
		...
		<form role="form" action="viva/viva_dashboard.php" method="POST">
