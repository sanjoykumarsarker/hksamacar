...
if ($conn->connect_error) {
  ...
  $sqldc ="update	users set task='".$ti."' where id='".$id_val."'";
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-envelope fa-2x"></i> <i class="glyphicon glyphicon-triangle-bottom"></i>
                    </a>
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li>
                            <form>
                                <button class= 'tbutton'>
                                    <i class="fa fa-cog fa-spin fa-fw"></i> <?php echo $_SESSION['id']; ?>
                                </button>
                            </form>
                        </li>
                        <li>
							<form target='show_all__iframe' action='devshow.php' method='GET'>
                                <button class= 'tbutton' name='g' type='submit' value= "<?php echo $_SESSION['strg']; ?>" >
                                    <i class="fa fa-print fa-fw"></i> Show All
                                </button>
                        </form>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <form  method="post" action="logout.php" >
                                <input type="hidden" name="logout" value="regsignup.php">
                                <button class= 'tbutton'>
...
<br>
  ...
  <div class="form-group">
	  ...
	  <div class="col-lg-11">
        ...
        <input id="bname" type="text" class="form-control on-type-bangla" name="bname" required  placeholder="নাম" autocomplete="off">
      </div>
    </div>
	</div>
	</div>
  ...
  <div class="col-lg-11">
     <div class="input-group">
      ...
      <input id="ename" style="text-transform:uppercase"  type="text" class="form-control" name="ename" required  placeholder="English">
      </div>
    </div>
	</div>
    </div>
  ...
  <div class="col-lg-11">
     <div class="input-group">
      ...
      <input id="ename" type="text" style="text-transform:uppercase"  class="form-control" name="spouse_name"    placeholder="Initiated name of Husband/Wife (If Applicable)">
      </div>
    </div>
	</div>
    </div>
  ...
  <div class="col-lg-11">
      ...
      <input id="address" type="text" style="text-transform:uppercase" class="form-control" name="address" required  placeholder="Address">
      </div>
    </div>
	</div>
    </div>
  ...
  <div class="col-lg-11">
      ...
      <input id="service" type="text" style="text-transform:uppercase"  class="form-control" name="service" required  placeholder="Service">
      </div>
    </div>
	</div>
    </div>
...
<br>
  ...
  <div class="col-lg-5">
      ...
      <input id="service" type="text" class="form-control" name="spouse_id"   placeholder="Spouse ID" onkeyup="spouseName(this.value)">
...
<br>
	...
	<span class='label label-info' id="upload-file-info"></span>
     ...
     <input type="submit" name="btn" value="Submit" id="submitBtn" data-toggle="modal" data-target="#confirm-submit" class="btn btn-success" />
    
    -->
     <input type="submit" name="btn" value="Submit" id="submitBtn" />
