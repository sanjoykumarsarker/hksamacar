...
// $_SESSION['cd']
$universal_message=get_namakarana_message();
...
$sqlr = "SELECT reg,
	ename, nchoice1,nchoice2,nchoice3,spouse_name,spouse_id

	FROM reg WHERE  templereg='$tid' and isinitiated!='Initiated' and result_viva='fit' and isinitiated!='Absent' ";
$resultr = $connr->query($sqlr);
if ($resultr->num_rows > 0) {
...
?>
    ...
    <marquee style="color:green"> <?php echo $universal_message; ?></marquee>
