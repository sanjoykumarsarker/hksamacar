...
?>
 ...
 <h4  id= "upload_list" style='color:green'>  </h4> 

 <p  id= "upload_si" style='color:blue'>  </p> 
...
for($nd=0;$nd< $highestRow; $nd++){
   ...
   if ($stmt_trans->execute()) { 
    ...
    echo "<script>   document.getElementById('upload_list').innerHTML='".$nnn."'</script>";
    echo "<script>   document.getElementById('upload_si').innerHTML='".intval($nd+1)."/".$highestRow."(".intval(100*intval($nd+1)/$highestRow)."%)'</script>";

    //echo "<p style='color:red'>$nnn <span style='color:blue'>----Uploaded</span></p> <br>";

 } else {
    // it didn't
    echo "<p style='color:red'>$nnn <span style='color:red'>----Not Uploaded</span></p> <br>";
