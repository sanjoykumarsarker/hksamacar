...
$sqld = "SELECT reg,
bname ,ename,finalname,templename    FROM reg WHERE reg like '$templeid%' and istatus1!='Postponed' and result_viva='fit' and istatus1!='Listed'  ";
...
echo $sqlinsert="INSERT INTO date_set(reg,bname,ename,sname,place,tithi,igroup,idate)VALUES('".$row["reg"]."','".$row["bname"]."','".$row["ename"]."','".$row["finalname"]."','".$place."','".$tithi."','".$group."','".$date."')";
