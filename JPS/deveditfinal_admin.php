...
$sqlu= "UPDATE reg SET bname='$bname',ename='$ename',age='$age',address='$address',phone='$phone',
		...
		istatus1='$istatus1',isinitiated='$istatus2',comments='$comments',iserial='$iserial',idate='$idate', status_viva='$status_viva' WHERE reg= '$reg'";

$sqlu_date= "UPDATE date_set SET bname='$bname',ename='$ename' ,iserial='$iserial',idate='$idate' WHERE reg= '$reg'";
