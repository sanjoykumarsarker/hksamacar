...
$sqlr = "SELECT reg ,	bname ,	ename ,spouse_name,spouse_id,	age ,	address ,	phone ,	service ,	
  gender ,	type,education ,	mstatus ,	nprefer ,imagename,nchoice1,nchoice2,nchoice3
...
if ($resultr->num_rows > 0) {
	...
	Name:	<span style='color:green;'>  ".$row["ename"]."</span> <hr>
	".$row["bname"]."   <hr>
   Spouse:<span style='color:red;'> 	".$row["spouse_name"].$row["spouse_id"]."&nbsp".ename($GLOBALS["spouse_id"]).  " </span>  <hr>
...
<marquee style='color:red'><?php echo $GLOBALS["spouse_id"]."&nbsp".ename($GLOBALS["spouse_id"]);?> </marquee>
</DIV>
