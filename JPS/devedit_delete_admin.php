...
$sqle = "SELECT 
   ...
   education,
   mstatus,
   nprefer,imagename,image_id,istatus1,comments, isinitiated ,status_viva 
...
$conne->close();
  ...
  <div style= "text-align:center" style="box-sizing: border-box; padding:10px;" >
   <div  id="login">
	...
	<form action='deveditfinal_delete_admin.php' method="POST">
...
<img src="upload/<?php echo $GLOBALS['imagename'];?>" height=100 width=100><br>
	...
	<div class="optionBox" >
		<label class="checkbox-inline">
		<input type="checkbox" name="status_viva" value=""/> NA </label>
		<label class="checkbox-inline">
		<input type="checkbox" name="status_viva" value="approved"/> Approved</label>
		<label class="checkbox-inline">
		<input type="checkbox" name="status_viva" value="submitted"/> Submitted</label>
		</label></div> 
	</div>
		<div class="col-lg-12" >
	...
	<div class="form-group">
							<div class="row">
								<div class="col-lg-12">
									<div class="input-group">
										<span class="input-group-addon"> Deleting Reason:  </span>
										<input id="msg" type="text"  value="" class="form-control" Required  name="deleting_reason" placeholder="Reason">
									</div>
								</div>
							</div>
						</div>
<hr>
	<div class="form-group">
							<div class="row">
								<div class="col-lg-12">
									<div class="input-group">
										<span class="input-group-addon"> Deleting Code:  </span>
										<input id="msg" type="text"  value="" class="form-control" Required  name="deleting_code" placeholder="Code">
									</div>
								</div>
							</div>
						</div>
...
$("input[name=status_viva][value='<?php echo$GLOBALS['status_viva'];?>']").prop("checked",true);
