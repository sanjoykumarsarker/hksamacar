...
*/
   ...
   $row = $resulte->fetch_assoc();
		...
		$GLOBALS['iserial']=$row["iserial"];
		$GLOBALS['idate']=$row["idate"];
					...
					<div  style="display:none">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-lg-12">
									<div class="input-group">
										<span class="input-group-addon">IDATE: </span>
										<input id="msg" type="text" value="<?php echo $GLOBALS['idate'];?>" class="form-control"  name="idate" placeholder="idate">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-lg-12">
									<div class="input-group">
										<span class="input-group-addon">ISERIAL: </span>
										<input id="msg" type="text" value="<?php echo $GLOBALS['iserial'];?>" class="form-control"  name="iserial" placeholder="iserial">
									</div>
								</div>
							</div>
						</div>
