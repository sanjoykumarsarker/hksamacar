    ...
    if (strg == "") {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("templeid").value = strg;

                document.getElementById("space").innerHTML = this.responseText;
            }
        };
        xmlhttp.open("POST","serial_update.php?g="+strg,true);
        xmlhttp.send();
    }
}
</script>
		...
		<footer>
            <div class="row">
                <div class="col-lg-12" style= "text-align:center;cursor:pointer;">
                    <Span style="border-right:1px solid black; padding:10px" >Copyright &copy; hksamacar 2017</span> <Span style="border-right:1px solid black;  padding:10px" > <a href="indexn.php" target="_blank" > Home </a> </span> <span style=" padding:10px;">
                    
                    
                      
                     <form method="post" action="dataexport2.php">
                     <input type="hidden" id="templeid" name="templeid" value="">
