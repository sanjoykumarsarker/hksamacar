...
<hr><hr><hr><hr>
             <div class="col" style="background-color: #deffeb;  ">
            ...
            <form id="contact" method="post" class="form" target="_blank" action="hks_despatch_vpp_entry.php" role="form">
                <button class="btn btn-info" type="submit" >VP Manual Despatch </button>
            </form>
            </div>

            <div class="col  form-group" style="padding: 0px 0px 0px 0px">
            <form id="contact" method="post" class="form" target="_blank" action="hks_despatch_vpp_entry.php" role="form">
                <button class="btn btn-info" type="submit" >VPP Manual Despatch</button>
            </form>
            </div>
            ...
            <form id="contact" method="post" class="form" target="_blank" action="hks_despatch_rp_entry.php" role="form">
                <button class="btn btn-info" type="submit" >RP Manual Despatch</button>
            </form>
            </div>
