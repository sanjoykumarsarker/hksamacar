        ...
        <div class="navbar-header">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown-submenu" >
                            <a class="test"><i class="fa fa-bar-chart-o fa-fw"></i> Reports<span class="fa fa arrow" style="color:white"></span></a>
                            <ul class="dropdown-menu">
                                <li > <a target="_blank" style="color: white; " href="jps_names_duplicate.php">Duplicate Names </a></li>
                                <li > <a target="_blank" style="color: white; " href="jps_names_duplicate.php">Gender Mismatch</a></li>
                                <li > <a target="_blank" style="color: white; " href="jps_names_duplicate.php">Bangla Names</a></li>
                                <li > <a target="_blank" style="color: white; " href="jps_names_duplicate.php">Input Errors</a></li>
...
?> 
      ...
      <!-- BARS CHART - lineandbars.js file -->     
            <div class="half-unit">
                ...
                <td>International</td><td><?php $dt1= "International"; echo count_dev_div($dt1); ?></td>

                <td>Dhaka</td><td><?php $dt1= "Dhaka"; echo count_dev_div($dt1); ?></td>
                
                <td>Chittagong</td><td><?php $dt1= "Chittagong"; echo count_dev_div($dt1); ?></td> </tr>
      ...
      <!-- FOLLOWERS BLOCK -->     
            <div class="half-unit">
				...
				<tr>
                <td>International</td><td><?php $dt1= "International"; echo count_temp_div($dt1); ?></td>

                <td>Dhaka</td><td><?php $dt1= "Dhaka"; echo count_temp_div($dt1); ?></td>
                <td>Chittagong</td><td><?php $dt1= "Chittagong"; echo count_temp_div($dt1); ?></td> </tr>
