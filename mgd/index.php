  ...
  <div class="container">
	...
	<li class="dropdown" >
                    ...
                    <ul class="dropdown-menu" style = "cursor:pointer;">
                        ...
                        <li><a tabindex="-1" target="_blank" href="dataentry_dashboard.php">Data Entry Dashboard </a></li>
						<li><a tabindex="-1" target="_blank" href="viva_login.php" >Viva</a></li>
                        ...
                        <li><a tabindex="-1"  href="https://harekrishnasamacar.com/JPS/photo_upload" >Photo Upload</a></li>
						...
						<li><a tabindex="-1" target="_blank" href="master.php">Master</a></li>
