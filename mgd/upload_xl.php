	...
	<div class="container">
		...
		<!-- Contact -->
				...
				<hr>
					...
					<form style="text-align:center" method ="post" action="create_temple.php">
<button class="btn btn-success" type="submit"> Create Temple</button>
</form>
					<br><br><br>
...
$sql = "SELECT tregid, tname,t_addr FROM tmpl where t_div='International'";
...
<br><br><br><br>
 ...
 <input type="submit"  class="btn btn-danger" value="Truncate International Only" /></li>
