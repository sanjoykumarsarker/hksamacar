...
var request = $.ajax({
  url: "test.php",
  method: "POST",
  data: { myData : JSON.stringify(optionTexts),nnn :JSON.stringify(nnn1) },
  dataType: "html"
});
...
$arr = array('International','Dhaka','Barisal','Chittagong','Khulna','Mymensingh','Rajshahi','Rangpur','Sylhet');
foreach ($arr as $div) {
...
if ($resultd->num_rows > 0) {
    echo " <ul><li class='ppp'>$div   <ol id='ilist' class='clist'  > ";
