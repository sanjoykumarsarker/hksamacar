        ...
        <!--target='iframe_ag_new_update'  -->
                        <form id="contact" method="post" class="form" role="form"  action ="hks_agent_update_data.php" >
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-md-6 form-group" style= "text-align: center;">
									<h6>	(<?php echo $GLOBALS['id_en'];?>) <?php echo $GLOBALS['Name'];?> </h6>
...
<select   class="custom-select" id="id_district" name="ag_dist" onchange="upazilaFunction(this.value);postofficeFunction(this.value)"  >
...
?>
                                ...
                                <div class="col  form-group">
                                <select class="custom-select"id="upazila" name="ag_ps"onchange="upzilaFunction(this.value)"  >
