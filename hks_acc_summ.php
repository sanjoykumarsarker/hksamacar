...
<div class="col-md-10 col-xl-10"> 
      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
            <div class="row">
              <div class="col-md-12">
              <p class="well lead" style="margin-top: 10px;" >  </p>
            <div class="container">
                <div class="row"> <!-- div da esquerda -->
                    ...
                    <div class="col-sm-9 contact-form" style="background-color: cornsilk;"> <!-- div da direita -->
                        <form id="contact" method="post" class="form" target="_blank" action="hks_acc_summ_data.php" onsubmit='disableButton()'  role="form">
							...
							<div class="row" style="background-color: cornsilk; padding: 5px 0px 0px 0px">
							<div class="col-xs-6 col-md-6 form-group">
									<p>	Expenses Entry System</p>  </div>	
...
<tr>
	<td>	<p>Devotee</p></td>
	<td>
		<input class="form-control" id="inputcidade" name="devotee_amount" placeholder="Amount" type="text" /></td>
	<td>
		<input class="form-control" id="inputcidade" name="devotee_comments" placeholder="Comments" type="text" /></td>
</tr>
...
<tr>
	<td>	<p>Postage</p></td>
	<td>
		<input class="form-control" id="inputcidade" name="postage_amount" placeholder="Amount" type="text" /></td>
	<td>
		<input class="form-control" id="inputcidade" name="postage_comments" placeholder="Comments" type="text" /></td>
</tr>
...
<tr>
	...
	<td><input class="form-control" id="inputcidade" name="travelling_amount" placeholder="Amount" type="text" /></td>
	<td>
		<input class="form-control" id="inputcidade" name="travelling_comments" placeholder="Comments" type="text" /></td>
</tr>
...
<tr>
	<td><p>Printing</p></td>
	<td><input class="form-control" id="inputcidade" name="printing_amount" placeholder="Amount" type="text" /></td>
	<td>
		<input class="form-control" id="inputcidade" name="printing_comments" placeholder="Comments" type="text" /></td>
</tr>
...
<tr>
	<td><p>Paper</p></td>
	<td><input class="form-control" id="inputcidade" name="paper_amount" placeholder="Amount" type="text" /></td>
	<td><input class="form-control" id="inputcidade" name="paper_comments" placeholder="Comments" type="text" /></td>
</tr>
...
<tr>
	...
	<td><input class="form-control" id="inputcidade" name="entertainment_amount" placeholder="Amount" type="text" /></td>
	<td><input class="form-control" id="inputcidade" name="entertainment_comments" placeholder="Comments" type="text" /></td>
</tr>
...
<tr>
	<td><p>Internet</p></td>
	<td><input class="form-control" id="inputcidade" name="internet_amount" placeholder="Amount" type="text" /></td>
	<td><input class="form-control" id="inputcidade" name="internet_comments" placeholder="Comments" type="text" /></td>
</tr>

<tr>
<td><p>Book</p></td>
	<td><input class="form-control" id="inputcidade" name="book_amount" placeholder="Amount" type="text" /></td>
	<td><input class="form-control" id="inputcidade" name="book_comments" placeholder="Comments" type="text" /></td>
										</tr>


<tr>
<td><p>Legal Fee</p></td>
<td><input class="form-control" id="inputcidade" name="legal_amount" placeholder="Amount" type="text" /></td>
<td><input class="form-control" id="inputcidade" name="legal_comments" placeholder="Comments" type="text" /></td>
										</tr>


<tr>
<td><p>Repair</p></td>
<td><input class="form-control" id="inputcidade" name="repair_amount" placeholder="Amount" type="text" /></td>
<td><input class="form-control" id="inputcidade" name="repair_comments" placeholder="Comments" type="text" /></td>
</tr>


<tr>
	<td><p>Asset Purchase</p></td>
	<td><input class="form-control" id="inputcidade" name="asset_amount" placeholder="Amount" type="text" /></td>
	<td><input class="form-control" id="inputcidade" name="asset_comments" placeholder="Comments" type="text" /></td>
</tr>

<tr>
	<td><p>TOTAL</p></td>
	<td><input class="form-control" id="inputcidade" name="asset_amount" placeholder="Amount" type="text" /></td>
	<td><button type ="submit"  id="btn" class="btn btn-danger">Submit</button></td>
</tr>
</form>
