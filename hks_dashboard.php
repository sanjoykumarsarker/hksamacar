  ...
  <div class="container-fluid">
    <div class="row" style="height: 100vh;">
      <div id="wrapper" class="col-md-2 col-xl-2">
        ...
        function count_total($str)
        {
          global $DB;
          $logic_1 = $str === 'agent' ? 'ID_EN<9999' : 'ID_EN>9999';
          $result = $DB->query("SELECT Name FROM tblMem WHERE " . $logic_1 . " AND status='CONT' ");
              ...
              <div class="container mt-3">
                <div class="row mb-3">
                  ...
                  <div class="col-md-4 col-sm-6 col-lg-3">
                    <div class="card">
                      <div class="card-header pl-2 text-white">Total Subscriber</div>
                      <div class="card-body text-primary px-2 py-4">
                        <div class="float-right mr-3 mt-2">
                          <i class="fa fa-address-book fa-2x"></i>
                        </div>
                        <div class="ml-3">
                          <?php
                          echo "<h1 class='counter'>" . count_total('subscriber')->num_rows . " </h1>";
                          ?>
                        </div>
                      </div>
                      <small class="ml-3">Active Persons <a href="#" class="sync float-right mr-3"><i class="fa fa-sync"></i></a></small>
                    </div>
                  </div>

                  <div class="col-md-4 col-sm-6 col-lg-3">
                    <div class="card">
                      <div class="card-header pl-2 text-white">Total Agent</div>
                      <div class="card-body text-success px-2 py-4">
                        <div class="float-right mr-3 mt-2">
                        ...
                        <div class="ml-3">
                          ...
                          echo "<h1 class='counter'>" . count_total('agent')->num_rows . " </h1>";
                          ?>
                        </div>
                      </div>
                      <small class="ml-3">Active Persons <a href="#" class="sync float-right mr-3"><i class="fa fa-sync"></i></a></small>
                  ...
                  <div class="col-md-4 col-sm-6 col-lg-3">
                    <div class="card">
                      <div class="card-header pl-2 text-white">Total Sale</div>
                      <div class="card-body text-info px-2 py-4">
                        <div class="float-right mr-3 mt-2">
                          <i class="fas fa-usd fa-2x"></i>
                        </div>
                        <div class="ml-3">
                          <?php
                          $total_query = $DB->query("SELECT ag_quantity AS total FROM tblMem WHERE ID_EN<10000 AND status='CONT' ");
                          ...
                          $total = number_format(array_sum($arr) + count_total('subscriber')->num_rows);
                          echo "<h1 class='counter'>" . $total . " </h1>";
                          ?>
                        </div>
                      </div>
                      <small class="ml-3">Paper Sale <a href="#" class="sync float-right mr-3"><i class="fa fa-sync"></i></a></small>
                    </div>
                  </div>

                  <div class="col-md-4 col-sm-6 col-lg-3">
                    <div class="card">
                      <div class="card-header pl-2 text-white">Sales POS</div>
                      <div class="card-body text-info px-2 py-2 text-center">
                        <a href="https://pos.harekrishnasamacar.com" target="_blank" id="gotoPos">
                          <img src="assets/images/pos-system-icon-21.jpg" alt="POS" width="100">
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row mt-4">
                    <div class="col-12 col-md-6">
                      <div class="main-map text-danger">
                        <h3 class="text-center">জেলা ভিত্তিক তথ্য</h3>
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 800 1000" style="enable-background:new 0 0 800 1000;" xml:space="preserve">
                          ...
                          <a href="#" id="Bhola" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_324">
                          ...
                          <a href="#" id="Satkhira" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_274">
                              <g>
                            ...
                            <text transform="matrix(1 0 0 1 180 690.524)" class="st1 st2">
                              সাতক্ষীরা
                            </text>
                          </a>

                          <a href="#" id="Khulna" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_90">
                              <g>
                                <g>
                              ...
                              <text transform="matrix(1 0 0 1 244 657)" class="st1 st2">খুলনা</text>
                            </g>
                          </a>

                          <a href="#" id="Barguna" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Patuakhali" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_355">
                              <g>
                          ...
                          <a href="#" id="Barishal" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_92">
                              <g>
                          ...
                          <a href="#" id="Lakshmipur" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Rangamati" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Khagrachari" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Chattogram" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_55">
                              <g>
                          ...
                          <a href="#" id="Feni" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Cumilla" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Chandpur" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_243">
                          ...
                          <a href="#" id="Shariatpur" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_410">
                          ...
                          <a href="#" id="Munshiganj" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Narayanganj" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Dhaka" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Faridpur" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_315">
                          ...
                          <a href="#" id="Manikganj" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_374">
                          ...
                          <a href="#" id="Magura" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Rajbari" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_368">
                          ...
                          <a href="#" id="Gazipur" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Kishoreganj" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Habiganj" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_260">
                          ...
                          <a href="#" id="Moulvibazar" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Sylhet" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Pabna" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Sirajganj" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_281">
                          ...
                          <a href="#" id="Jashore" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Meherpur" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Kushtia" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_272">
                          ...
                          <a href="#" id="Natore" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Rajshahi" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Naogaon" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Gaibandha" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_322">
                          ...
                          <a href="#" id="Rangpur" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_47">
                          ...
                          <a href="#" id="Panchagarh" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Kurigram" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_301">
                          ...
                          <a href="#" id="Bogura" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Brahmanbaria" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_328">
                          ...
                          <a href="#" id="Mymensingh" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Bagerhat" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_285">
                              <g>
                          ...
                          <a href="#" id="Bandarban" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Sunamganj" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Narail" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Lalmonirhat" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_356">
                          ...
                          <a href="#" id="Dinajpur" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Thakurgaon" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Nilphamari" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_283">
                          ...
                          <a href="#" id="Joypurhat" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Jhalokati" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Gopalganj" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Madaripur" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Chapai-Nawabganj" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_343">
                          ...
                          <a href="#" id="Netrakona" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Pirojpur" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_483">
                          ...
                          <a href="#" id="Chuadanga" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Jhenaidah" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Coxs-Bazar" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_264">
                          ...
                          <a href="#" id="Sherpur" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Narsinghdi" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" data-toggle="tooltip" data-placement="top" title="1200" id="Jamalpur">
                            <g id="dist_530">
                          ...
                          <a href="#" id="Tangail" data-toggle="tooltip" data-placement="top" title="1200">
                          ...
                          <a href="#" id="Noakhali" data-toggle="tooltip" data-placement="top" title="1200">
                            <g id="dist_266">
                    ...
                    <div class="col-12 col-sm-6">
                      <div class="text-center p-2">
                        <h3>বিভাগীয় তথ্য</h3>
                        <nav class="tabbable">
                          <div class="nav nav-pills" aria-orientation="vertical" id="myTab" role="tablist">
                            <?php
                            $divisions = $DB->query('SELECT id, name, bn_name FROM divisions');
                            while ($division = $divisions->fetch_assoc()) {
                              $d = $division['name'];
                              $bn_name = $division['bn_name'];
                              $id = $division['id'];
                              echo "<a class='nav-link' id='$d-tab' data-id='$id' data-toggle='tab' href='#$d' role='tab' aria-controls='$d' aria-selected='true'>$bn_name</a>";
                            }
                            ?>
                          </div>
                        </nav>
                        <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" id="dhaka" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <small class="ml-3">জেলা ভিত্তিক তথ্য<a href="#" class="float-right mr-3 load-dist"><i class="fa fa-sync"></i></a></small>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <script defer src="https://cdn.jsdelivr.net/npm/waypoints@4.0.1/lib/jquery.waypoints.min.js"></script>
      ...
      <script>
        $('document').ready(() => {
          ...
          $('#myTab').on('click', function(e) {
            e.preventDefault();
            divisionId = $(e.target).data('id');
            loadDivision(divisionId);
          });

          function loadDivision(id) {
            fade_section();
            $('#division_info').load('/hks_dashboard_division_info.php', {
              id
            });
          }
          ...
          $('[data-toggle="tooltip"]').delay(5000).each(function() {
            let id = this.id;
            let districts = localStorage.getItem('districts');
            if (districts) {
              $(this).attr('title', JSON.parse(districts)[id])
            } else {
              $(this).attr('title', 0)
            }
          });
          ...
          function fade_section() {
            $('#division_info').animate({
              opacity: '0.1'
            }, "slow");
            $('#division_info').delay(1400).animate({
              opacity: '1'
            }, "slow");
          }

          $('.load-dist').on('click', (e) => {
            e.preventDefault();
          ...
          // $('#gotoPos').click(function(e) {
          //   e.preventDefault();
          //   // var myWindow = window.open("https://pos.harekrishnasamacar.com/", 'POS Application', "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=400,height=400");
          //   var myWindow = window.open("http://localhost:8000/admin/login", 'POS Application', "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=200,height=200");
          //   // myWindow.focus();
          //   // console.log(myWindow);
          //   // myWindow.postMessage('login', '*');
          //   // myWindow.localStorage.setItem('automatic', 'true');
          //   // console.log(myWindow);
          //   myWindow.document.$("input[name ='firstName']").html('test');
          // })
