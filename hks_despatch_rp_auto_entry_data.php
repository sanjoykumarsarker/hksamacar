...
$stmt = $conn->prepare("update tblIssue set despatch=0    where    vername=:vername and sent_mode='rp'");
...
$stmt = $conn2->prepare("update tblIssue set despatch=:despatch    where  VPNo=:VPNo AND sent_mode='rp' and vername=:vername");
