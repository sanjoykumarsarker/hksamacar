...
<body>
			        ...
			        <div class="col-sm-12 col-md-12  contact-form" style=" "> <!-- div da direita -->
                        <form id="contact" method="post" class="form" target="hks_auto_vpp_entry_iframe" action="hks_auto_despatch_vpp_entry_iframe.php" role="form">
                            	<div class="row" style="background-color: #3CB371; padding: 10px 0px 0px 0px">
                                ...
                                <div class="form-group row">
                                    <label for="isn" class="col-sm-3 col-form-label" style="font-size: 18px; font-weight: bold;">VPP Serial</label>
                                    <div class="col-sm-9" >
                                    <input type="text" class="form-control" id ="isn" name="column_range" placeholder="Enter Despatch Serial" required >
                                    </div>
                                </div>
                                </div>
 			...
 			<div class="table-responsive">
                ...
                <iframe name="hks_auto_vpp_entry_iframe"height="550" width=100%  style="border:0" style="overflow-y:scroll; overflow-x:scroll;"></iframe>
