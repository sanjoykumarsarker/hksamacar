			        ...
			        <div class="col-sm-12 col-md-12  contact-form" style=""> <!-- div da direita -->
                        <form id="contact" method="post" class="form" target="hks_vp_entry_iframe" action="hks_vpp_entry_iframe.php" role="form">
                            <div class="row" style="background-color: #3CB371; padding: 10px 0px 0px 0px">
                                ...
                                <div class="col-xs-4 col-md-4 form-group" >
                                <div class="form-group row">
                                    <label for="isn" class="col-sm-4 col-form-label" style="font-size: 18px; font-weight: bold;">VPP Range</label>
                                    <div class="col-sm-8" >
                                    <input type="text" class="form-control" id ="isn" name="vp_range" placeholder="Six Digit-First Two Book Number" required >
                                    </div>
                                </div>
                                </div>
