...
request5.done(function( msg1 ) {
  document.getElementById("space5").innerHTML =msg1;
});
...
var request4 = $.ajax({
  url: "print_certificate_onepage_data.php",
  method: "POST",
  data: { myData : JSON.stringify(date)  },
  dataType: "html"
});
        ...
        <div class="col-sm-4 col-lg-4">
            <div class="dash-unit">
                ...
                <div class="container-fluid" style="text-align:center;" >
                    ...
                    <button type="button" class="btn btn-outline btn-success btn-block" onclick="printDiv1('space1')" > Serial </button>
                    <button type="button" class="btn btn-outline btn-warning btn-block" onclick="printDiv2('space2')" > Seatplan </button>
                                        <button type="button" class="btn btn-outline btn-warning btn-block" onclick="printDiv5('space5')" > Asan</button>

					<button type="button" class="btn btn-outline btn-info btn-block" onclick="printDiv3('space3')" > Initiation Call List </button> 
                    <button type="button" class="btn btn-outline btn-danger btn-block" onclick="printDiv4('Certificate')" > Certificate </button> 
