...
<div class="container">
	...
	<label class="control-label"  >Division</label>
	  <p>
        <select required class="form-control" id="country"   name="t_div" onchange="update()">
    ...
    <p>
        <select required class="form-control" id="city" name="t_dist"  onchange="myFunction(this)">
...
function myFunction(selTag) {
    ...
    document.getElementById("demo").innerHTML = "You selected: " + x;
						...
						<div>
							<label class="control-label  " for="PS"> Police Station/ Upazila</label>
										<span class="form-control-static"> </span>
										<input id="msg" type="text"   required class="form-control" name="t_ps" value="Sadar">
						</div>		
						<div>
							<label class="control-label  " for="PS"> Address</label>
										<span class="form-control-static"> </span>
										<input id="msg" type="text" required class="form-control" name="t_addr" placeholder="Enter Village/Union/Road">
						</div>
<br>
							...
							<div class="row">	
								<div class="col-lg-11">
									<div class="input-group">
										...
										<input id="msg" type="text" required class="form-control" name="tname_b" placeholder="মন্দির ">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-lg-11">
									<div class="input-group">
										...
										<input id="msg" type="text" required class="form-control" name="trecom_b" placeholder="অনুমোদনকারী ">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-lg-11">
									<div class="input-group">
										...
										<input id="msg" type="text" required class="form-control" name="trecom" placeholder="Recommended">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-lg-11">
									<div class="input-group">
										...
										<input id="msg" type="text" required class="form-control" name="t_ph" placeholder="Phone">
									</div>
								</div>
							</div>
						</div>
