...
mysqli_set_charset($conn_all,"utf8");
   $sql_all = "SELECT transid,vername,VPNo,transaction_id, SentDate,agcpy ,transid  FROM tblIssue where ( sent_mode='vp' and despatch =".$g." AND vername =".$print_issue." ) order by cast(VPNo as unsigned) ";
...
<div class="page">
  ...
  <div class="row">
    <div class="col-sm-6"  > <br>
        ...
        <span style="font-size:12px; position: absolute; top: 8px; right: 25px;"> ভিপি-'.$g.'</span>
		<h6> ঢাকা সদর </h6>
		<h6> আর পি ব্যাগ-</h6>
		<h6> ঢাকা এম এন্ড এস ও  <br> আর পি সেট </h6>
		</div>
		
		<table style="width:100%" >
		<tr><th>#</th><th> ভিপি</th><th>নাম</th><th>#</th><th> ভিপি</th><th>নাম</th></tr>
		';
		...
		echo '
            ...
            <div>
            <p style="font-weight:bolder;">সর্বমোট: ভিপি '. $banglaNumber->engToBn(sizeof($arr_vp)).'টি ('. $banglaNumber->numToWord(sizeof($arr_vp)) .'টি) মাত্র।</p>
            </div>
	</div>
    <div class="col-sm-6"  > <br>
    <div style="text-align:center;">
