...
<body>
			        ...
			        <div class="col-sm-12 col-md-12  contact-form" style="background-color: #ffd7eb;"> <!-- div da direita -->
                        <form id="contact" method="post" class="form" target="hks_auto_vp_entry_iframe" action="hks_auto_despatch_vp_entry_iframe.php" role="form">
                                ...
                                <div class="form-group row">
                                    <label for="isn" class="col-sm-3 col-form-label" style="font-size: 18px; font-weight: bold;">VP Serial</label>
                                    <div class="col-sm-9" >
 			...
 			<div class="table-responsive">
                ...
                <iframe name="hks_auto_vp_entry_iframe"height="550" width=100%  style="border:0" style="overflow-y:scroll; overflow-x:scroll;"></iframe>
