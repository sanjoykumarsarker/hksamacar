...
var request = $.ajax({
  url: "test.php",
  method: "POST",
  data: { myData : JSON.stringify(optionTexts),sss:nnn },
  dataType: "html"
});
...
if ($resultd->num_rows > 0) {
    echo "<ul><li  onclick='dropdown()' class='class2'> $div   <ol id='ilist' class='clist'> <span   class=caret> </span> </li> ";
