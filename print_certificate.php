...
<br>
<div class="container" style="background-color:; text-align:left; height:500px; overflow-y: scroll;"  >
<br><br>
...
<button id="ok">Update Serial</button>
<input type="button" onclick="printDiv('space')" value="print a div!" />
</div>
